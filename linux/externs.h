...
#define PING		"/usr/bin/ping"
#define PING6		"/usr/bin/ping6"
#define TRACERT		"/usr/bin/traceroute"
#define TRACERT6	"/usr/bin/traceroute6"
...
const char *get_string(const char *, const char *, __int8_t *, int *);
void make_string(char *str, int, const __int8_t *buf, int);
